...
/*
	...
	CopyFile(L"Sprites/Laharl.png", (g_AssetDir + L"Sprites/Laharl.png").c_str(), false);
	//wcout << (g_AssetDir + L"Sprites/Laharl.png") << endl;
}
...
void Tutorial_Primitive::SetTextureFromFileName(LPCWSTR pSrcFile)
{
	D3DXCreateTextureFromFile(DXUTGetD3D9Device(), pSrcFile, &m_pTex);
}